...
.animate-writing {
  animation: writing 2s ease-in-out forwards;
...
const writingAnimation = colorAnimation;
...
function App() {
  ...
  const handleFormSubmit = async (formData: {
    ...
    try {
      ...
      const requestData = {
        protocol: formData.companyName,
        protocol_url: formattedCompanyUrl,
        category: formData.companyIndustry || undefined,
        blockchain: formData.companyHq || undefined,
        token_address: null, // We don't have this field in the form data yet
      };
  ...
  const renderProgressComponents = () => {
    ...
    if (
      ...
      // Research Briefings section removed as requested
    }
